...
# Create a mixed dataset for TSNE visualization (Currently not working)
num_test = 500
...
# Show MNIST and MNIST-M samples
...
class MNISTModel(object):
    ...
    def _build_model(self):
        ...
        # Standard CNN model for feature extraction
        ...
        # Procedure for class prediction
        ...
        # Small procedure for domain prediction with adversarial loss
...
def train_and_evaluate(training_mode, graph, model, verbose=False):
    ...
    with tf.Session(graph=graph) as sess:
        ...
        for i in range(num_steps):
            ...
            # Adaptation parameters and learning rate as described in the paper
            p = float(i) / num_steps
            l = 2. / (1. + np.exp(-10. * p)) - 1
            lr = 0.01 / (1. + 10 * p)**0.75
...
# Visualisation: Currently not working.
